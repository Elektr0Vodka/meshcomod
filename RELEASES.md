...
**More Heltec V4 meshcomod images** (USB/BLE/Wi‑Fi companions, plain repeaters): see [`prebuilt/releases/v1.14.0.41/notes.md`](prebuilt/releases/v1.14.0.41/notes.md).
