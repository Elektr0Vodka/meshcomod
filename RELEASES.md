...
## v1.14.0.53 — 2026-03-23

**Firmware version:** v1.14.0.53 (meshcomod on upstream 1.14+).

**Highlights:**
- **Companion OTA made robust again:** removed repeater-http-only lock and restored multi-mirror flow.
- **Mirror rounds:** retries the full chain for multiple rounds (`flasher https/http`, raw GitHub, jsDelivr, repeater https/http) with Wi-Fi reconnect/backoff between rounds.
- **Body safety retained:** HTML/gzip/non-firmware mirrors are skipped, not flashed.
...
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.53/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.53/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.53/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.53/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.53/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.53/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.52 — 2026-03-23

**Firmware version:** v1.14.0.52 (meshcomod on upstream 1.14+).

**Highlights:**
- **Companion OTA set to one path only:** for meshcomod firmware URLs, OTA now uses **only** `http://repeater.meshcomod.com/firmware-download/...` (no flasher/raw/jsdelivr/https mirrors).
- **No alternate fallback paths:** behavior is intentionally narrowed to the single method that previously reached `OTA: HTTP OK, flashing`.

**Prebuilt binaries (use [flasher.meshcomod.com](https://flasher.meshcomod.com) — Easy mode auto-downloads versions; for manual upload, use Custom firmware):**

| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.52/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.52/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.52/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.52/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.52/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.52/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.51 — 2026-03-23

**Firmware version:** v1.14.0.51 (meshcomod on upstream 1.14+).

**Highlights:**
- **Use only working proxy host first:** OTA now runs **flasher-first** mirror order and no longer spends attempts on `repeater.meshcomod.com` for firmware download (that endpoint currently returns HTML for this path).
- **Fallbacks kept:** flasher HTTPS/HTTP, then raw GitHub, then jsDelivr.
- **No transport teardown:** TCP/WSS session behavior unchanged.

**Prebuilt binaries (use [flasher.meshcomod.com](https://flasher.meshcomod.com) — Easy mode auto-downloads versions; for manual upload, use Custom firmware):**

| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.51/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.51/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.51/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.51/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.51/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.51/Heltec_v3_companion_radio_usb_tcp.bin) |
...
**Highlights:**
- **Companion OTA HTTP fallbacks fixed:** `http://` proxy URLs (repeater/flasher meshcomod fallbacks) now use a **plain `WiFiClient`**; **`https://`** still uses **`WiFiClientSecure`**. Previously all URLs went through TLS client, which could yield `connection refused` on HTTP targets while repeater OTA still worked.
- **No TCP/WSS teardown:** app session behavior unchanged.
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.47/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.47/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.47/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.47/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.47/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.47/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.46 — 2026-03-23

**Firmware version:** v1.14.0.46 (meshcomod on upstream 1.14+).

**Highlights:**
- **Companion OTA scheduling parity with repeater:** `ota url` runs **synchronously** in the meshcomod command path instead of deferring to the next `MyMesh::loop()`, removing the behavioral delta that correlated with companion-only `connection refused` on the same network.
- **Shared OTA diagnostics:** `ESP32Board` emits the same `OTA: diag` / lookup lines for companion and repeater (repeater still via `CommonCLI`); **`ota netdiag`** for a quick Wi‑Fi/DNS snapshot without flashing.
- **Robust retries:** between fallback attempts, HTTPS/client cleanup avoids stale sockets; concurrent OTA is rejected with a clear error.
- **No TCP/WSS teardown:** session behavior matches v1.14.0.45 (no intentional transport pause for OTA).
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.46/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.46/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.46/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.46/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.46/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.46/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.45 — 2026-03-23

**Firmware version:** v1.14.0.45 (meshcomod on upstream 1.14+).

**Highlights:**
- **OTA transport behavior aligned:** companion no longer disables TCP/WSS during `ota url`, so app sessions are not intentionally dropped by OTA startup.
- **Fallback chain unchanged:** raw GitHub → jsDelivr → repeater/flasher proxies (HTTPS/HTTP).
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.45/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.45/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.45/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.45/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.45/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.45/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.44 — 2026-03-23

**Firmware version:** v1.14.0.44 (meshcomod on upstream 1.14+).

**Highlights:**
- **Companion OTA transport parity:** during `ota url`, companion now pauses TCP/WSS servers to free network/socket resources for outbound OTA HTTP(S), then restores TCP on non-rebooting failures.
- **Companion-specific reliability fix:** addresses multi-transport contention not present in repeater-only OTA flow.
- **Keeps fallback chain:** raw GitHub → jsDelivr → repeater/flasher proxies over HTTPS and HTTP.
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.44/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.44/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.44/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.44/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.44/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.44/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.43 — 2026-03-23

**Firmware version:** v1.14.0.43 (meshcomod on upstream 1.14+).

**Highlights:**
- **Companion OTA fallback chain:** after raw GitHub and jsDelivr, OTA now retries `repeater.meshcomod.com` and `flasher.meshcomod.com` firmware proxies over HTTPS, then HTTP.
- **Matches repeater ecosystem:** reuses meshcomod `/firmware-download/` proxy hosts already used by repeater/flasher tooling.
- **Works on restricted networks:** improves success when direct GitHub/CDN 443 is blocked/refused from STA network.
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.43/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.43/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.43/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.43/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.43/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.43/Heltec_v3_companion_radio_usb_tcp.bin) |

---

## v1.14.0.42 — 2026-03-23

**Firmware version:** v1.14.0.42 (meshcomod on upstream 1.14+).

**Highlights:**
- **GitHub OTA fallback:** If direct HTTPS to `raw.githubusercontent.com` is refused, firmware auto-falls back to jsDelivr (`cdn.jsdelivr.net`) for the same artifact path.
- **No command changes:** Existing `ota url https://raw.githubusercontent.com/...` continues to work; fallback is automatic.
- **Keeps detailed diagnostics:** OTA still emits connect retries and explicit low-level HTTPClient error strings for troubleshooting.
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.42/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.42/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.42/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.42/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.42/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.42/Heltec_v3_companion_radio_usb_tcp.bin) |
...
**Highlights:**
- **HTTP OTA connect hardening:** Adds retry logic for initial HTTPS connect/GET with reconnect waits to reduce transient `ERR: HTTP -1` failures.
- **Actionable OTA errors:** Negative HTTP failures now include the low-level HTTPClient error text (for example `ERR: HTTP -1 (...)`) in the final response line.
- **OTA diagnostics over binary push:** Companion emits explicit connect retry/error lines on `PUSH_CODE_BINARY_RESPONSE` during OTA start for easier field troubleshooting.
- **Target parity:** V4 OLED, V4 TFT+touch, and V3 companion binaries (merged + non-merged).
...
| Device | Merged (recommended) | Non-merged |
|--------|----------------------|------------|
| Heltec V4 (OLED) | [heltec_v4_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.41/heltec_v4_companion_radio_usb_tcp-merged.bin) | [heltec_v4_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.41/heltec_v4_companion_radio_usb_tcp.bin) |
| Heltec V4 TFT + touch | [heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin](prebuilt/releases/v1.14.0.41/heltec_v4_tft_companion_radio_usb_tcp_touch-merged.bin) | [heltec_v4_tft_companion_radio_usb_tcp_touch.bin](prebuilt/releases/v1.14.0.41/heltec_v4_tft_companion_radio_usb_tcp_touch.bin) |
| Heltec V3 | [Heltec_v3_companion_radio_usb_tcp-merged.bin](prebuilt/releases/v1.14.0.41/Heltec_v3_companion_radio_usb_tcp-merged.bin) | [Heltec_v3_companion_radio_usb_tcp.bin](prebuilt/releases/v1.14.0.41/Heltec_v3_companion_radio_usb_tcp.bin) |
